...
Structured supplementary materials for a protocol-oriented review of person re-identification (ReID).
...
- `protocols/`: versioned protocol notes and future machine-readable protocol definitions.
...
Please cite the associated review manuscript and, when referring to a specific dataset or protocol, cite the original source listed in the relevant table.
